...
[heimrichhannot/contao-flare-bundle](https://github.com/heimrichhannot/contao-flare-bundle) is a [Contao CMS](https://contao.org/) extension that streamlines the filtering and listing of entities on the frontend and also supports individual detail views (readers).
